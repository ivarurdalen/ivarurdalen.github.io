---
title: Downloading data for Oslo Stock Exchange
...
In this tutorial we are going to download stock price data for Oslo Stock Exchange and store it in a database.s