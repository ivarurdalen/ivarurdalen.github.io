...
**Languages:** <i class="fa-brands fa-python"></i> Python, <i class="fa-brands fa-square-js"></i> JavaScript, <i class="fa-brands fa-r-project"></i> R, C++  
**Databases:** <i class="fa-solid fa-database" aria-hidden="true"></i> SQL (MySQL, PostgreSQL, BigQuery, Snowflake)  
**Frameworks:** FastAPI, Dash(Plotly)  
**Cloud computing:** <i class="fa-solid fa-cloud"></i> AWS, Azure, GCP <i class="fa-brands fa-docker"></i> Docker, Kubernetes  
...
# Ivar Soares Urdalen
Looking for roles in the Data Engineering / Data Science / Finance space  
