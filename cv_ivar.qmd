...
**Languages:** <i class="fa-brands fa-python"></i> Python, <i class="fa-brands fa-square-js"></i> JavaScript, C++  
...
Currently working as a Data Engineer in the [Alternative Data](https://en.wikipedia.org/wiki/Alternative_data_(finance)) space for finance.  
  
In addition to work, I am currently pursuing a [MSc in Financial Engineering](https://www.wqu.edu/programs/mscfe/)
from [World Quant University](https://www.wqu.edu/) while also taking courses/certifications
and developing my own coding projects in intersection of data engineering and finance.
Check out my [website](https://ivarurdalen.github.io) to learn more about me and connect.
